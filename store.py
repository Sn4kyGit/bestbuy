# store.py
"""Store entity that manages Product objects and orders."""
...
class Store:
    ...
    def __init__(self, products_list: List[products.Product] | None = None) -> None:
        ...
        for item in shopping_list:
            ...
            if qty > prod.get_quantity():
                raise ValueError(
                    ...
                    f"requested {qty}, available {prod.get_quantity()}"
                )
